...
namespace StroitelnyProdajnik.Data;

public partial class BuilderPodContext : DbContext
{
    public BuilderPodContext()
    {
    }

    public BuilderPodContext(DbContextOptions<BuilderPodContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=db8329.public.databaseasp.net; Database=db8329; User Id=db8329; Password=2Bb_a7@QCx4=; Encrypt=True; TrustServerCertificate=True; MultipleActiveResultSets=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BuildingMaterial>(entity =>
        {
            entity.HasKey(e => e.MaterialId).HasName("PK__Building__C50613176361943B");
        ...
        {
            entity.HasKey(e => e.ObjectId).HasName("PK__Construc__9A6192B18FB97E1B");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.ConstructionObjects)
                ...
                .HasConstraintName("FK__Construct__Custo__60A75C0F");
        });

        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B83434CEDE");
        ...
        {
            entity.HasKey(e => e.ObjectMaterialId).HasName("PK__ObjectMa__707B4AB4B6EF10FD");
            ...
            entity.HasOne(d => d.Material).WithMany(p => p.ObjectMaterials)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ObjectMat__Mater__6A30C649");

            entity.HasOne(d => d.Object).WithMany(p => p.ObjectMaterials)
                .HasForeignKey(d => d.ObjectId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ObjectMat__Objec__693CA210");
        });

        modelBuilder.Entity<ObjectWork>(entity =>
        {
            entity.HasKey(e => e.ObjectWorkId).HasName("PK__ObjectWo__53959C52D44BE9E4");
            ...
            entity.HasOne(d => d.Object).WithMany(p => p.ObjectWorks)
                .HasForeignKey(d => d.ObjectId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ObjectWor__Objec__656C112C");

            entity.HasOne(d => d.WorkType).WithMany(p => p.ObjectWorks)
                .HasForeignKey(d => d.WorkTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ObjectWor__WorkT__66603565");
        });
        ...
        {
            entity.HasKey(e => e.WorkTypeId).HasName("PK__WorkType__CCC06CC059F003C6");
